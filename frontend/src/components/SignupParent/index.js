...
import styles from '../SignInParent/style.module.scss';
...
const SignUpParentPage = () => (
  <section className={`App-body d-flex ${styles.parentPage} ${signinStyle.container}`}>
    <CardDeck className="mx-auto my-auto card-deck">
      ...
      <Card className="d-flex signIn-card right-side">
        <SignTabs title="parent" type={1} />
        <div className="my-auto signIn-form">
          <div>
            <span className="signin-type mn-4">PARENT </span>
            <span className="educator-signin mn-4">SIGN UP</span>
          </div>
          <SignInForm />
          <div className="signup-text">
            Already have an account? <Link className="signup-link" to={ROUTES.SIGN_IN_PARENT}>Sign in</Link>
          </div>
          <div className="legal">
