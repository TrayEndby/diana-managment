...
class MonthlyCounselingPage extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      resourceList: null,
  ...
  fetchResourceList = async () => {
    let resourceList = await MarketService.listWebinars('monthly counselling');
...
export default withRouter(MonthlyCounselingPage);
