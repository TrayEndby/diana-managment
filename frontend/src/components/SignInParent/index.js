      ...
      <Card className="d-flex signIn-card right-side">
        ...
        <div className="my-auto signIn-form">
          ...
          <div className="signup-text">
            No account? <Link className="signup-link" to={ROUTES.SIGN_UP_PARENT}>Create one</Link>
          </div>
          <div className="legal">
...
export default SignInParentPage;