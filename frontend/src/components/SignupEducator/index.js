...
import styles from '../SigninEducator/style.module.scss';
  ...
  <section className={`App-body d-flex ${styles.educatorPage} ${signinStyle.container}`}>
    <CardDeck className="mx-auto my-auto card-deck">
      ...
      <Card className="d-flex signIn-card right-side">
        <SignTabs title="educator" type={1} />
        <div className="my-auto signIn-form">
          ...
          <div className="signup-text">
            Already have an account? <Link className="signup-link" to={ROUTES.SIGN_IN_EDUCATOR}>Sign in</Link>
          </div>
          <div className="legal">
...
export default SignUpEducatorPage;