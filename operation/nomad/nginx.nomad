...
gsutil -m rsync -d -r gs://kyros-diana-frontend /kyros/bucket
...
EOF
    ...
    task "nginx" {
      ...
      config {
        image = "us.gcr.io/kyros-arion/diana-nginx@sha256:2272dd5c4a54ac6c50072358069945d0842ea491179bb112840d0710b4bed117"
