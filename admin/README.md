...
## Instructions from Kyros

This repo is used for kyros admin dashboard. In order to reuse the service code,
/service and /constants are symlinked from the main kyros repo
